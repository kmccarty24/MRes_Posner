...
io = launchHubServer(iohub_config_name = 'iohub_config.yaml', experiment_code = 'Posner')
...
fixation = visual.Circle(win, size =  5, lineColor = 'white', fillColor = 'red')
...
for trialN in trials:
    ...
    io.sendMessageEvent(text="TRIAL%i_START" %(t+1),sec_time=flip_time)
